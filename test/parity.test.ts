...
test("pinned registry inventory keeps unique providers and only fixture-backed support", () => {
  ...
  expect(supported.map(provider => provider.id)).toEqual(["codex", "clinepass", "opencodego", "fireworks", "copilot", "zai", "kimi", "moonshot", "openrouter", "deepseek", "deepinfra", "venice", "poe", "chutes", "huggingface", "v0", "hyper"])
