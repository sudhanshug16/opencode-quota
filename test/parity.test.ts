...
test("pinned registry inventory keeps unique providers and only fixture-backed support", () => {
  ...
  expect(supported.map(provider => provider.id)).toEqual(["codex", "clinepass", "opencodego", "fireworks", "copilot", "zai", "kimi", "moonshot", "synthetic", "openrouter", "deepseek", "deepinfra", "venice", "poe", "chutes", "neuralwatt", "huggingface", "v0", "hyper"])
